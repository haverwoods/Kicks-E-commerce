...
const Navigationbar = () => {
  return (
    ...
    {/* <div className="flex items-center font-medium justify-around w-full h-14 "> */}
    <div className="flex items-center font-medium justify-around  mt-2 rounded-lg bg-white relative  w-full h-14  ">
       ...
       <div className="top-2.5 ml-1 pl-5 ">
          <img src="../asset/Group.png" className=" mt-3 ml-1 h-6 w-20 "></img>
         </div>
      {/* <div className=" top 2.5 mt-3 pl-4 mx-auto ">
